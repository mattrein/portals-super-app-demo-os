...
require(["OutSystems/ClientRuntime/Main", "SuperappSDK.appDefinition", "OutSystems/ClientRuntime/Debugger"], function (OutSystems, SuperappSDKAppDefinition, Debugger) {
...
return OS.Application.default.initialize(SuperappSDKAppDefinition, OS.Interfaces.Application.InitializationType.Full, new OS.Format.DateTimeFormatInfo("yyyy-MM-dd", "HH:mm:ss"), new OS.Format.NumberFormatInfo(".", "")).then(function (success) {
