...
require(["OutSystems/ClientRuntime/Main", "System_.appDefinition", "OutSystems/ClientRuntime/Debugger"], function (OutSystems, System_AppDefinition, Debugger) {
...
return OS.Application.default.initialize(System_AppDefinition, OS.Interfaces.Application.InitializationType.Full, new OS.Format.DateTimeFormatInfo("yyyy-MM-dd", "HH:mm:ss"), new OS.Format.NumberFormatInfo(".", "")).then(function (success) {
